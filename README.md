...
located:
```console
sudo tar -xvzf mvn-check-1.4.1-bin.tar.gz --directory /opt
export PATH=$PATH:/opt/mvn-check-1.4.1/bin
```
...
- Find the "Path" variable, choose "Edit", and add `;C:\mvn-check-1.4.1\bin` at the end
